...
- Web Security (XSS, SQLi – PortSwigger)
- Automation with Python
- Detection Engineering Basics (SOC perspective)
- Cloud Security Fundamentals (IAM, S3, permissions)
...
scripts/
Custom tools and automation scripts (e.g., Nmap output parsing, recon helpers).

detections/
SOC-oriented notes: detection ideas, pseudo-rules, MITRE ATT&CK mappings.

outputs/
Scan outputs and processed results.
...
This lab serves as a public record of technical evolution.
